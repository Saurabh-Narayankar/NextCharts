import {
  ...
  import PieCustomisation from "./pieChart-customisationTab";
   
  
  
  
  const PieChartFunctions = ({ setValue, setData, createData, finalData, setFinalData, setBooleanValue }) => {
      ...
      <Box width="100%" bgColor="blackAlpha.900">
        ...
        <Flex width="39%" marginLeft="4rem" flexDir="column" gap="70px">
          ...
          <Flex width="100%" flexDir="column">
            ...
            <TabPanel bgColor="#140936" borderBottomRadius="8px">
              <PieCustomisation setValue={setValue} setBooleanValue={setBooleanValue} />
            </TabPanel>
          </TabPanels>
        </Tabs>
  ...
  export default PieChartFunctions;